...
& 'C:\Program Files\cURL\bin\curl.exe' -v -u $SECRET_username -L "https://api.bitbucket.org/2.0/repositories/$CONFIG_team_name/$CONFIG_project_name/downloads/$file" -o $file